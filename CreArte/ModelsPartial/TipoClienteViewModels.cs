...
namespace CreArte.ModelsPartial
{
    ...
    // (Se usa en GET /TiposCliente/Index)
    // ------------------------------------------------------
    public class TipoClienteViewModels
    {
        public List<TIPO_CLIENTE> Items { get; set; } = new();
    ...
    // (Rutas: GET/POST /TiposCliente/Create y GET/POST /Categorias/Edit/{id})
    // ------------------------------------------------------
    public class TipoClienteCreateVM
    {
        [Display(Name = "ID Tipo Cliente")]
        [Required, StringLength(10)]
        public string TC_ID { get; set; } = default!;
    ...
    // (Ruta: GET /TiposCliente/DetailsCard?id=...)
    // ------------------------------------------------------
    public class TipoClienteDetailsVM
    {
        public string TC_ID { get; set; } = default!;
        public string TC_NOMBRE { get; set; } = default!;
        public string? TC_DESCRIPCION { get; set; }
